...
exports.stats = function (req, res) {
    ...
    (function (err, obj) {
        ...
        // HACK TO WORK WITH EMBER CONVENTION. Should create an adapter
        obj.id = 1;
        res.send({stats: obj});
    });
};
...
exports.updateState = updateState = function (req, res) {
    var id = req.params.id
        , state = req.params.state;
...
exports.retryJobByType = function(req, res) {
    var type = req.params.type;

    Job.rangeByType(type, 'failed', 0, -1, 'asc', function(err, jobs) {
        async.eachSeries(jobs, function(j, callback) {
