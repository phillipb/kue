      ...
      compile: {
        options: {
          templateName: function(sourceFile) {
            ...
            if((/^client\/components\//).test(fileName)){
        ...
        files: {
          "public/js/templates-<%= meta.buildId %>.js": ["client/templates/**/*.hbs", "client/components/**/*.hbs"]
        }
      }
    },
    ...
    uglify: {
      vendor: {
          src: ['<banner:meta.banner>'
            ...
            , 'client/assets/vendor/highlight.pack.js'
          ],
