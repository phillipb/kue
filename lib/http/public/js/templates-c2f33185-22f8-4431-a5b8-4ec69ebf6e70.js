...
function program1(depth0,data) {
  ...
  var buffer = '', stack1;
  data.buffer.push("\n  		<div class=\"count\">");
  stack1 = helpers._triageMustache.call(depth0, "stat.inactiveCount", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
...
function program3(depth0,data) {
  ...
  var buffer = '', stack1;
  data.buffer.push("\n  		<div class=\"count\">");
  stack1 = helpers._triageMustache.call(depth0, "stat.activeCount", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
...
function program5(depth0,data) {
  ...
  var buffer = '', stack1;
  data.buffer.push("\n  		<div class=\"count\">");
  stack1 = helpers._triageMustache.call(depth0, "stat.failedCount", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
...
function program7(depth0,data) {
  ...
  var buffer = '', stack1;
  data.buffer.push("\n  		<div class=\"count\">");
  stack1 = helpers._triageMustache.call(depth0, "stat.completeCount", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
...
function program9(depth0,data) {
  ...
  var buffer = '', stack1;
  data.buffer.push("\n  		<div class=\"count\">");
  stack1 = helpers._triageMustache.call(depth0, "stat.delayedCount", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
